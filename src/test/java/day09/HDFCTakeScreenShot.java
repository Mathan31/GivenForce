...
public class HDFCTakeScreenShot {
	...
	public static void switchWindow() throws Exception {
		...
		Library.takeFullScreenShotAsFile(driver, "HomeFullScreen");
		Library.takeScreenshotAsFile(driver, "HDFCHomePage");
		  ...
		  getPageInfo();
		  Library.takeFullScreenShotAsFile(driver, "PensionFullScreen");
		  ...
		  getPageInfo();
		  Library.takeFullScreenShotAsFile(driver, "MutualFullScreen");
