...
public class Browser_Setting_Ex {
	
	public static String sURL = "https://www.ebay.com/";
	public static int iBrowserType = 2; //1-Chrome,2-IE,3-FF
	public static WebDriver driver=null;
	public static DesiredCapabilities oCap;
	...
	public static void launchBrowser() {
		...
		case 1:
			...
			options.merge(oCap);
			//oCap.setCapability(ChromeOptions.CAPABILITY, options);
		...
		case 2:
			...
			InternetExplorerOptions oIE = new InternetExplorerOptions();
			oIE.ignoreZoomSettings();
			//oIE.merge(oCap);
			//oCap.setCapability(InternetExplorerDriver.IGNORE_ZOOM_SETTING, true);
			driver = new InternetExplorerDriver(oIE);
			break;
